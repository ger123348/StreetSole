...
<body>
    <nav class="fixed top-0 w-full z-50 glass-nav px-8 py-4 flex justify-between items-center">
        ...
        <div class="space-x-8 text-sm font-medium uppercase tracking-widest">
            <a href="<?php echo e(route('login')); ?>" class="bg-white text-black px-6 py-2 rounded-full font-bold transition hover:bg-gray-200">Login / Register</a>
        </div>
    </nav>
    ...
    <header class="h-screen flex flex-col justify-center items-center text-center px-4">
        ...
        <a href="<?php echo e(route('login')); ?>" class="border border-white px-10 py-4 hover:bg-white hover:text-black transition duration-500 uppercase font-bold tracking-widest text-xs">
            Jelajahi Koleksi
        </a>
    </header>
</body>
</html><?php /**PATH D:\Data_Kuliah\Joki\Web\StreetSole\resources\views/index.blade.php ENDPATH**/ ?>